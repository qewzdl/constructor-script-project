...
This script generates secure credentials (database password and JWT secret)
and starts the containers. After deployment, complete the setup by visiting
the web interface at your domain (or http://localhost for local testing).
...
# Site settings (will be configured via web setup at /setup)
# SITE_DOMAIN=your-domain.com
# SITE_EMAIL=admin@your-domain.com
# SITE_NAME=My Site
